...
clear
echo
toilet -f big "TOOLS" | lolcat
sleep 1
toilet -f slant " S . X . C " | lolcat
sleep 1
toilet -f shadow " ZL1Z3R " | lolcat
echo ""
sleep 1
echo $i"|+++|xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx|+++|"
echo $i"|+++|$cy Coded By : ZL1Z3R                   $i|+++|"
echo $i"|+++|$cy Team     : SWORD X CYB3R            $i|+++|"
echo $i"|+++|$cy Versions : 0.0.2                    $i|+++|"
...
echo $pu"==============================================="
echo $bi" 16.cc buat nyari kartu credit untuk carding"
echo $ku"==============================================="
echo $cy" 17.Nonton Stars Wars biar gk bosen ngehack mulu"
echo $i"==============================================="
echo $pur" 18.Hulk Ddos"
echo $pu"==============================================="
echo $bi" 19.Lazymux"
echo $ku"==============================================="
echo $cy" 20.TOOLS-X"
...
echo $cy"Sedang Menginstall Tools"
cd $HOME
git clone https://github.com/ZL1Z3R/cc
cd cc
sh Install.sh
fi
...
echo $cy"Sedang Menginstall Tools"
cd $HOME
git clone https://github.com/ZL1Z3R/start-wars
cd start-wars
sh install.sh
fi
